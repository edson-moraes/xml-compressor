...
public class XmlCompressor {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String maxCompressionResult = maxCompressionInstance.encodeFromFile(filePath);
            int maxCompressionSize = maxCompressionResult.getBytes().length;
            ...
            String maxFidelityResult = maxFidelityInstance.encodeFromFile(filePath);
            int maxFidelitySize = maxFidelityResult.getBytes().length;
